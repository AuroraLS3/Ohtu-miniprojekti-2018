...
public class LanguageFileReaderTest {
	...
	public void readLanguageTest() {
		...
		assertEquals("Welcome to the reading recommendation app !", locale.get(LanguageKeys.GREET));
		assertEquals("Supported commands:", locale.getAsList(LanguageKeys.MAINCOMMANDS).get(0));
